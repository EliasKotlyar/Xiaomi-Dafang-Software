...
#ifdef CONFIG_LCD_HS_DS07012D
#include <linux/hs_ds07012d.h>
static struct platform_hs_ds07012d_data hs_ds07012d_pdata= {
	.gpio_lcd_disp = GPIO_PB(30),
	.gpio_lcd_de   = 0,		//GPIO_PC(9),	/* chose sync mode */
	.gpio_lcd_vsync = 0,		//GPIO_PC(19),
	.gpio_lcd_hsync = 0,		//GPIO_PC(18),
...
/* LCD device */
struct platform_device hs_ds07012d_device = {
	.name		= "hs_ds07012d-lcd",
	.dev		= {
		.platform_data = &hs_ds07012d_pdata,	
	},
};
#endif
...
#ifdef CONFIG_LCD_HS_DS07012D // 60Hz@vpll=888MHz
	.name = "800x480",
	.refresh = 55,
	.xres = 800,
	.yres = 480,
