...
static struct jztsc_pin orion_tsc_gpio[] = {
	[0] = {GPIO_CTP_IRQ,		HIGH_ENABLE},
	[1] = {GPIO_CTP_WAKE_UP,	HIGH_ENABLE},
};

static struct jztsc_platform_data orion_tsc_pdata = {
	.gpio		= orion_tsc_gpio,
	.x_max		= 800,
	.y_max		= 480,
};
	...
	i2c_board_info orion_i2c0_devs[] __initdata = {
	{
		I2C_BOARD_INFO("gwtc9xxxb_ts", 0x05),
		.platform_data = &orion_tsc_pdata,
	},
};
#endif
#endif
...
static int __init orion_board_init(void)
{
/* dma */
...
/* mmc */
	...
	jz_device_register(&jz_msc0_device, &orion_inand_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &orion_tf_pdata);
#endif
#ifdef CONFIG_MMC2_JZ4780
	jz_device_register(&jz_msc2_device, &orion_sdio_pdata);
#endif
...
/* panel and bl */
	...
	platform_device_register(&orion_backlight_device);
#endif
...
/* nand */
	...
	i2c_register_board_info(0, orion_i2c0_devs, ARRAY_SIZE(orion_i2c0_devs));
#endif
...
arch_initcall(orion_board_init);
