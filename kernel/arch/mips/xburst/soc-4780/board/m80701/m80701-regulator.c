...
static struct platform_device *fixed_regulator_devices[] __initdata = {
	&m80701_vcc5_regulator_device,
	&m80701_vbus_regulator_device,
	&m80701_vcim_regulator_device,
	&m80701_vlcd_regulator_device,
};
 ...
 */
static struct regulator_info m80701_pmu_regulators[] = {
	{"OUT1", &m80701_vcore_init_data},
	{"OUT3", &m80701_vccio_init_data},
...
static struct pmu_platform_data m80701_pmu_pdata = {
	.gpio = GPIO_PA(28),
	.num_regulators = ARRAY_SIZE(m80701_pmu_regulators),
	.regulators = m80701_pmu_regulators,
	.charger_board_info = &charger_board_info,
};

#define PMU_I2C_BUSNUM 0

struct i2c_board_info m80701_pmu_board_info = {
	I2C_BOARD_INFO("act8600", 0x5a),
	.platform_data = &m80701_pmu_pdata,
};

static int __init m80701_pmu_dev_init(void)
{
	...
	client = i2c_new_device(adap, &m80701_pmu_board_info);
	if (!client) {
...
subsys_initcall_sync(m80701_pmu_dev_init);
