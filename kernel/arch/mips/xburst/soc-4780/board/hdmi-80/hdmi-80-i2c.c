...
static struct jztsc_pin hdmi_80_tsc_gpio[] = {
	[0] = {GPIO_CTP_IRQ,		HIGH_ENABLE},
	[1] = {GPIO_CTP_WAKE_UP,	HIGH_ENABLE},
};

static struct jztsc_platform_data hdmi_80_tsc_pdata = {
	.gpio		= hdmi_80_tsc_gpio,
	.x_max		= 1024,
	.y_max		= 600,
};
#endif
...
static struct i2c_board_info hdmi_80_i2c1_devs[] __initdata = {
...
static struct i2c_board_info hdmi_80_i2c2_devs[] __initdata = {
#ifdef CONFIG_SP0838
	{
...
static struct i2c_board_info hdmi_80_i2c3_devs[] __initdata = {
#ifdef CONFIG_TOUCHSCREEN_LDWZIC
	{
		I2C_BOARD_INFO("ldwzic_ts", 0x01),
		.platform_data	= &hdmi_80_tsc_pdata,
	},
#endif
...
static int __init hdmi_80_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C1_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(1, hdmi_80_i2c1_devs, ARRAY_SIZE(hdmi_80_i2c1_devs));
#endif

#if (defined(CONFIG_I2C_GPIO) || defined(CONFIG_I2C2_JZ4780))
	i2c_register_board_info(2, hdmi_80_i2c2_devs, ARRAY_SIZE(hdmi_80_i2c2_devs));
#endif

#if (defined(CONFIG_I2C3_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(3, hdmi_80_i2c3_devs, ARRAY_SIZE(hdmi_80_i2c3_devs));
#endif
	return 0;
}

arch_initcall(hdmi_80_i2c_dev_init);
