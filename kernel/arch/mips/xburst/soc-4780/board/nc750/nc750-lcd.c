 ...
 *
 * JZ4780 nc750 board lcd setup routines.
 *
...
static int nc750_backlight_init(struct device *dev)
{
	return 0;
}

static void nc750_backlight_exit(struct device *dev)
{
}

static struct platform_pwm_backlight_data nc750_backlight_data = {
	.pwm_id		= 0,
	.max_brightness	= 255,
	.dft_brightness	= 80,
	.pwm_period_ns	= 10000, /* 100 kHZ */
	.init		= nc750_backlight_init,
	.exit		= nc750_backlight_exit,
};

/* Backlight Device */
struct platform_device nc750_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.platform_data	= &nc750_backlight_data,
	},
};
