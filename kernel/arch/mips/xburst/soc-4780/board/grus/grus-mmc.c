...
static struct mmc_recovery_info grus_inand_recovery_info = {
	.partition_info			= grus_inand_partition_info,
	.partition_num			= ARRAY_SIZE(grus_inand_partition_info),
	.permission			= MMC_BOOT_AREA_PROTECTED,
	.protect_boundary		= 21*MBYTE,
};
	
struct jzmmc_platform_data grus_inand_pdata = {
	.removal  			= DONTCARE,
	.sdio_clk			= 0,
...
struct jzmmc_platform_data grus_tf_pdata = {
	.removal  			= REMOVABLE,
	.sdio_clk			= 0,
	.ocr_avail			= MMC_VDD_32_33 | MMC_VDD_33_34,
