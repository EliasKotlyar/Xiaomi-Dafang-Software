...
static struct platform_device *fixed_regulator_devices[] __initdata = {
	&ry1000_vcc5_regulator_device,
	&ry1000_vbus_regulator_device,
	&ry1000_vwifi_regulator_device,
//	&ry1000_ucharger_regulator_device,
//	&ry1000_vlcd_regulator_device,
};


static int __init ry1000_pmu_dev_init(void)
{
	int i;
...
subsys_initcall_sync(ry1000_pmu_dev_init);
