...
static struct jz_battery_info  ry1000_battery_info = {
		.max_vol        = 4050,
		.min_vol        = 3600,
		.usb_max_vol    = 4100,
		.usb_min_vol    = 3760,
...
/* panel and bl */
	...
	platform_device_register(&ry1000_backlight_device);
#endif
...
/* ADC*/
#ifdef CONFIG_BATTERY_JZ4780
	adc_platform_data.battery_info = ry1000_battery_info;
...
arch_initcall(ry1000_board_init);

static struct wake_lock keep_alive_lock;
static int __init ry1000_board_lateinit(void)
{
...
late_initcall(ry1000_board_lateinit);
