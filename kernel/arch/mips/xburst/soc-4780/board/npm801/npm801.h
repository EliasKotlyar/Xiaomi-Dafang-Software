 ...
 * mmc platform data
 **/
extern struct jzmmc_platform_data npm801_inand_pdata;
extern struct jzmmc_platform_data npm801_tf_pdata;
extern struct jzmmc_platform_data npm801_sdio_pdata;
