...
static struct jz_battery_info  npm801_battery_info = {
		.max_vol        = 4080,
		.min_vol        = 3600,
		.usb_max_vol    = 4100,
		.usb_min_vol    = 3760,
...
/* panel and bl */
	...
	platform_device_register(&npm801_backlight_device);
#endif
...
/* ADC*/
#ifdef CONFIG_BATTERY_JZ4780
	adc_platform_data.battery_info = npm801_battery_info;
...
arch_initcall(npm801_board_init);
