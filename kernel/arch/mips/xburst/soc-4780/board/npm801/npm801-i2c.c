...
static struct jztsc_pin npm801_tsc_gpio[] = {
...
#if (defined(CONFIG_I2C_GPIO) || defined(CONFIG_I2C2_JZ4780))
static struct i2c_board_info npm801_i2c2_devs[] __initdata = {
#ifdef CONFIG_OV7675
	{
...
static struct i2c_board_info npm801_i2c3_devs[] __initdata = {
...
static int __init npm801_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C1_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(1, npm801_i2c1_devs, ARRAY_SIZE(npm801_i2c1_devs));
#endif

#if (defined(CONFIG_I2C_GPIO) || defined(CONFIG_I2C2_JZ4780))
	i2c_register_board_info(2, npm801_i2c2_devs, ARRAY_SIZE(npm801_i2c2_devs));
#endif

#if (defined(CONFIG_I2C3_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(3, npm801_i2c3_devs, ARRAY_SIZE(npm801_i2c3_devs));
#endif
	return 0;
}

arch_initcall(npm801_i2c_dev_init);
