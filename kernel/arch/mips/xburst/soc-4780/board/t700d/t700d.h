 ...
 * mmc platform data
 **/
extern struct jzmmc_platform_data t700d_inand_pdata;
extern struct jzmmc_platform_data t700d_tf_pdata;
extern struct jzmmc_platform_data t700d_sdio_pdata;
...
#endif
extern struct platform_device t700d_backlight_device;
...
#define GPIO_MC32X0_INT1		GPIO_PF(9)
...
#define GPIO_HI704_EN			GPIO_PB(18)
#define GPIO_HI704_RST         GPIO_PB(26)

#define GPIO_HI253_EN			GPIO_PB(19)
