...
static struct jz_battery_info  t700d_battery_info = {
		.max_vol        = 4080,
		.min_vol        = 3600,
		.usb_max_vol    = 4100,
		.usb_min_vol    = 3760,
...
static int __init t700d_board_init(void)
{
/* dma */
...
/* mmc */
	...
	jz_device_register(&jz_msc0_device, &t700d_inand_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &t700d_sdio_pdata);
#endif
#ifdef CONFIG_MMC2_JZ4780
	jz_device_register(&jz_msc2_device, &t700d_tf_pdata);
#endif
#else
#ifdef CONFIG_MMC0_JZ4780
	jz_device_register(&jz_msc0_device, &t700d_tf_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &t700d_sdio_pdata);
#endif
...
/* panel and bl */
	...
	platform_device_register(&t700d_backlight_device);
#endif
...
/* ADC*/
#ifdef CONFIG_BATTERY_JZ4780
	adc_platform_data.battery_info = t700d_battery_info;
...
/* ac charger */
	platform_device_register(&t700d_ac_charger_device);
/* li-ion charger */
	platform_device_register(&t700d_li_ion_charger_device);
...
arch_initcall(t700d_board_init);
