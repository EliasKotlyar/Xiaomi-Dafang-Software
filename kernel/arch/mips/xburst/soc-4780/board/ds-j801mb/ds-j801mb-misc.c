...
static struct jz_battery_info  ds_j801mb_battery_info = {
		.max_vol        = 4050,
		.min_vol        = 3600,
		.usb_max_vol    = 4100,
		.usb_min_vol    = 3760,
...
static int __init ds_j801mb_board_init(void)
{
/* dma */
...
/* mmc */
	...
	jz_device_register(&jz_msc0_device, &ds_j801mb_inand_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &ds_j801mb_sdio_pdata);
#endif
#ifdef CONFIG_MMC2_JZ4780
	jz_device_register(&jz_msc2_device, &ds_j801mb_tf_pdata);
#endif
#else
#ifdef CONFIG_MMC0_JZ4780
	jz_device_register(&jz_msc0_device, &ds_j801mb_tf_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &ds_j801mb_sdio_pdata);
#endif
...
arch_initcall(ds_j801mb_board_init);
