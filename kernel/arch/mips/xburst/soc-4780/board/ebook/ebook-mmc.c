...
static struct mmc_recovery_info ebook_inand_recovery_info = {
	.partition_info			= ebook_inand_partition_info,
	.partition_num			= ARRAY_SIZE(ebook_inand_partition_info),
	.permission			= MMC_BOOT_AREA_PROTECTED,
	.protect_boundary		= 21*MBYTE,
};

struct jzmmc_platform_data ebook_inand_pdata = {
	.removal  			= DONTCARE,
	.sdio_clk			= 0,
	...
	.recovery_info			= &ebook_inand_recovery_info,
	.gpio				= NULL,
...
struct jzmmc_platform_data ebook_sdio_pdata = {
	.removal  			= MANUAL,
	.sdio_clk			= 1,
	.ocr_avail			= MMC_VDD_32_33 | MMC_VDD_33_34,
