...
struct mmc_partition_info test_inand_partition_info[] = {
...
static struct mmc_recovery_info test_inand_recovery_info = {
	.partition_info			= test_inand_partition_info,
	.partition_num			= ARRAY_SIZE(test_inand_partition_info),
	.permission			= MMC_BOOT_AREA_PROTECTED,
	.protect_boundary		= 21*MBYTE,
};
	
struct jzmmc_platform_data test_inand_pdata = {
	.removal  			= DONTCARE,
	.sdio_clk			= 0,
...
static struct card_gpio test_tf_gpio = {
	.cd				= {GPIO_SD2_CD_N,	LOW_ENABLE},
	.pwr				= {GPIO_SD2_VCC_EN_N,	HIGH_ENABLE},
};

struct jzmmc_platform_data test_tf_pdata = {
	.removal  			= REMOVABLE,
	.sdio_clk			= 0,
	.ocr_avail			= MMC_VDD_32_33 | MMC_VDD_33_34,
...
struct jzmmc_platform_data test_sdio_pdata = {
	.removal  			= MANUAL,
	.sdio_clk			= 1,
	.ocr_avail			= MMC_VDD_32_33 | MMC_VDD_33_34,
