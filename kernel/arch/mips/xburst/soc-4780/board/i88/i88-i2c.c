...
static struct jztsc_platform_data i88_tsc_pdata = {
	.gpio		= i88_tsc_gpio,
	.x_max		= 1344,
	.y_max		= 960,
};
...
static struct i2c_board_info i88_i2c1_devs[] __initdata = {
#ifdef CONFIG_TOUCHSCREEN_MG8698S
	{
		I2C_BOARD_INFO("mg8698s_tsc", 0x44),
		.platform_data	= &i88_tsc_pdata,
	},
#endif
...
#if (defined(CONFIG_I2C_GPIO) || defined(CONFIG_I2C2_JZ4780))
static struct i2c_board_info i88_i2c2_devs[] __initdata = {
#ifdef CONFIG_OV7675
	{
...
static struct i2c_board_info i88_i2c3_devs[] __initdata = {
...
static int __init i88_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C1_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(1, i88_i2c1_devs, ARRAY_SIZE(i88_i2c1_devs));
#endif

#if (defined(CONFIG_I2C_GPIO) || defined(CONFIG_I2C2_JZ4780))
	i2c_register_board_info(2, i88_i2c2_devs, ARRAY_SIZE(i88_i2c2_devs));
#endif

#if (defined(CONFIG_I2C3_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(3, i88_i2c3_devs, ARRAY_SIZE(i88_i2c3_devs));
#endif
	return 0;
}

arch_initcall(i88_i2c_dev_init);
