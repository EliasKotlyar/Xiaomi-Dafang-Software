...
#define CLK_NAME_CGU_MACPHY	"cgu_macphy"
	CLK_ID_CGU_GMAC,
#define CLK_NAME_CGU_GMAC	"cgu_gmac"
	CLK_ID_CGU_VPU,
...
enum {	//SHOULD BE CHECKED!!
	CGU_BCH,CGU_ISP,  CGU_PCM, CGU_CIM,CGU_SSI,
	CGU_UHC,CGU_MSC2,CGU_MSC1,CGU_MSC0,CGU_LPC,
	CGU_I2S,CGU_MACPHY,CGU_GMAC,CGU_VPU, CGU_DDR,
	CGU_MSC_MUX
};
