...
#define GPIO_LCD_DISP		PCA9539_EXT_GPIO(9)
...
/* ****************************GPIO MMC START******************************** */
#define GPIO_MMC_RST_N		PCA9539_EXT_GPIO(8)
...
#define WL_REG_EN	PCA9539_EXT_GPIO(1)
#if 0
...
/* BT gpio */
#define HOST_WAKE_BT	PCA9539_EXT_GPIO(12)
#define BT_WAKE_HOST	GPIO_PA(0)
#define BT_REG_EN	PCA9539_EXT_GPIO(7)
