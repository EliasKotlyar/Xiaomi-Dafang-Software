...
*/
		...
		if (Elem->Wcid < MAX_LEN_OF_MAC_TABLE)
		{
			...
			//	printk("ApCliRcvBeaconTime 1..........OK\n");
			}
			else
			{
			//	printk("ApCliRcvBeaconTime 1..........FAIL\n");
			}
		}
			...
			&& (NdisEqualMemory(pAd->ApCfg.ApCliTab[0].CfgApCliBssid, ie_list->Bssid, MAC_ADDR_LEN)))
		{
			...
			/* P2P CLI also update ApCfg.RssiSample for AsicAdjustTxPower() caculation*/
			Update_Rssi_Sample(pAd, &pAd->ApCfg.RssiSample, &RxWI);
		}
#endif /* P2P_SUPPORT */
#endif /* APCLI_SUPPORT */
