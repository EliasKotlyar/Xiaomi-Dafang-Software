...
enum machine_mode
{
  ...
  V4QImode,                /* config/mips/mips-modes.def:30 */
  V2HImode,                /* config/mips/mips-modes.def:30 */
  V1SImode,                /* config/mips/mips-modes.def:29 */
  V8QImode,                /* config/mips/mips-modes.def:31 */
  V4HImode,                /* config/mips/mips-modes.def:31 */
  V2SImode,                /* config/mips/mips-modes.def:31 */
  V16QImode,               /* config/mips/mips-modes.def:35 */
  V8HImode,                /* config/mips/mips-modes.def:35 */
  V4SImode,                /* config/mips/mips-modes.def:35 */
  V2DImode,                /* config/mips/mips-modes.def:35 */
  ...
  V2SFmode,                /* config/mips/mips-modes.def:32 */
  V4SFmode,                /* config/mips/mips-modes.def:36 */
  V2DFmode,                /* config/mips/mips-modes.def:36 */
  MAX_MACHINE_MODE,
